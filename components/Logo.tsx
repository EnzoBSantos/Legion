...
const Logo: React.FC = () => {
  return (
    <div className="flex flex-col items-center justify-center">
      ...
      <h1 className="font-serif text-3xl tracking-wider mt-4">LEGIÓN NOFAP</h1>
      <p className="font-serif text-sm text-slate-400 tracking-[0.2em] mt-1">DISCIPLINA DEL MONJE</p>
    </div>
  );
};
